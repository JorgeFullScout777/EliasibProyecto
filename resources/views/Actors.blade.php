                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#actorModalUpdate" data-id="{{ $actor->actor_id }}" data-first_name="{{ $actor->first_name }}" data-last_name="{{ $actor->last_name }}">
