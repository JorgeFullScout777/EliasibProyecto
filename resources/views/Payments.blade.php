                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-warning" data-toggle="modal" data-target="#updatePaymentModal" data-payment_id="{{ $payment->payment_id }}" data-customer_id="{{ $payment->customer_id }}" data-staff_id="{{ $payment->staff_id }}" data-rental_id="{{ $payment->rental_id }}" data-amount="{{ $payment->amount }}">
