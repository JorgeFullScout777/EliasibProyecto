            ...
            <div class="modal-content">
                ...
                <form action="{{ route('staff.update', $member->staff_id) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="address_id">Address ID</label>
                            <input type="number" class="form-control" id="address_id" name="address_id" value="{{ old('address_id', $member->address_id) }}" required>
                        </div>

                        <!-- Picture -->
                        <div class="form-group">
                            <label for="picture">Picture URL</label>
                            <input type="text" class="form-control" id="picture" name="picture" value="{{ old('picture', $member->picture) }}">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="store_id">Store ID</label>
                            <input type="number" class="form-control" id="store_id" name="store_id" value="{{ old('store_id', $member->store_id) }}" required>
                        </div>
