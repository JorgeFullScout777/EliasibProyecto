...
<body class="dark-mode">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            ...
                                            <button class="btn btn-success mb-3" data-toggle="modal" data-target="#addressModal">
    ...
    <div class="modal fade" id="addressModal" tabindex="-1" role="dialog" aria-labelledby="addressModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="addressForm" method="POST" action="{{ route('Address') }}">
                    @csrf
    ...
    <!-- Modal de actualización de Address -->
    <div class="modal fade" id="addressModalUpdate" tabindex="-1" role="dialog" aria-labelledby="addressModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
    ...
    <script>
        $('#addressModalUpdate').on('show.bs.modal', function(event) {
