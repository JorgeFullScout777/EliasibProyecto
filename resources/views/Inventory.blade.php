                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editInventoryModal" data-id="{{ $data->inventory_id }}" data-film_id="{{ $data->film_id }}" data-store_id="{{ $data->store_id }}">
